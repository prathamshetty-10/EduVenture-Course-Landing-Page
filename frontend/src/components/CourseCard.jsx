...
function CourseCard({ data }){//data is an object with info about a particular course
    ...
    return(
        <div onClick={()=>navigate("/course/description",{state:{...data}})} className="text-white w-[20rem] h-[450px] lg:h-[450px] shadow-xl shadow-black border-yellow-800 border rounded-lg cursor-pointer group overflow-hidden bg-zinc-700 hover:scale-105 mt-10" >
