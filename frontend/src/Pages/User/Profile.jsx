            ...
            <div className=" bg-gray-800 min-h-[90vh] flex items-center justify-center">
                <div className=" overflow-x-scroll w-[40vh] lg:w-[70vh] flex flex-col justify-center gap-3 rounded-lg p-4 text-white shadow-[0_0_10px_black] bg-gray-800">
                    ...
                    <div className="flex items-center justify-between gap-2">
                        ...
                        <Link to="/user/editprofile" className="py-4 w-1/2 mt-2 bg-yellow-600 hover:bg-yellow-400 transition-all ease-in-out duration-300 text-black font-semibold hover:text-blue-950 rounded-md lg:py-1 text-lg cursor-pointer  text-center ">   Edit Profile</Link>
                    </div>
