...
function Checkout(){
    ...
    return(
        ...
        <form noValidate onSubmit={handleSubscription} className="flex flex-col justify-center gap-3 rounded-lg p-4 text-white w-80 lg:w-96 shadow-[0_0_10px_black] bg-gray-800">
