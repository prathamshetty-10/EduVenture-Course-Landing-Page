        ...
        <div className="flex flex-col px-10 lg:px-0  items-center gap-10 justify-center min-h-[90vh] py-10 text-white  bg-gray-800">
            ...
            {(lectures &&  lectures.length>0)?
                ...
                <div className="py-5 space-y-5 w-[20rem] lg:w-[28rem] p-2 rounded-lg shadow-[0_0_10px_black] mx-5 lg:mx-0">
                    ...
                    <div>
                        <h1>
                        <span className="text-yellow-500 text-xl font-bold">Title is:{" "}
                ...
                <ul className=" py-5 text-center font-bold w-[20rem] lg:w-[28rem] p-2 rounded-lg shadow-[0_0_10px_black] space-y-4 m-5 lg:m-0">   
