    ...
    return(
        <HomeLayout>
            <div className=" min-h-[90vh]  pt-5 flex flex-col flex-wrap gap-10 text-white bg-gray-800">
                <h1 className="text-center text-5xl mt-20 lg:mt-10 font-semibold text-yellow-500">
                    ADMIN DASHBOARD
                </h1>
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-5 m-auto mx-10 lg:shadow-[0_0_10px_black]">
                    <div className="flex flex-col items-center gap-10 lg:shadow-[0_0_10px_black] p-5  rounded-md">
                        <div className="w-50 lg:w-80 h-50 lg:h-80">
                            <Pie data={userData}/>
                        </div>
                    ...
                    <div className="flex flex-col items-center gap-10 p-5 lg:shadow-[0_0_10px_black] rounded-md">
                        <div className="h-80 w-full relative">
                            <Bar className="absolute bottom-0 h-80 w-full" data={salesData}/>
                        
                        </div>
                        <div className="grid grid-cols-2 gap-5">
                            <div className="flex items-center shadow-[0_0_10px_black] justify-between p-2 lg:p-5 gap-3 lg:gap-5 rounded-md ">
                            ...
                            <div className="flex items-center justify-between p-2 lg:p-5 gap-5 rounded-md shadow-[0_0_10px_black]">
                                <div className="flex flex-col items-center justify-center">
                                <GiMoneyStack className="text-green-500 text-5xl"/>
                                <p className="font-semibold">
                                    Total Revenue
                                    </p>
                                    <h3 className="text-3xl lg:text-4xl font-bold">{allPayments?.count*499}</h3>
